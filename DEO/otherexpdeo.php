<html>
    ...
    <body class="image-slider">
        ...
        <div id="box">
            <center><h2> Other Expences  </h2>

            <form action="reg.php" method="post">
                <table cellspacing="10">
                    <tr>
                <td><p class=data1>Expence for</p></td>
                <td><input name="cname" type="text" class="inputvalues" placeholder="Expence Type" required><br><br></td>
                    </tr>
                    <tr>
