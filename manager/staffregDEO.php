    ...
    <div id="box">
        <center><h2> Register Staff </h2>
            <form action="staffregDEOin.php" method="post">
                ...
                <td><input type="password" placeholder="Enter Password" name="cpassword" id="confirm_password" required></td>
                    ...
                    <table align=center>
                    <tr>
                    <td><button name="register" class="btn" type="submit">Register</button></td>
                    
                    
                    <td><a href="staffregDEO.php"><button type="button" class="btn">New Record</button></a></td>
        ...
        <!-- <?php
			if(isset($_POST['register']))
			{
				...
				{
				$query = "SELECT * from dataentry WHERE  FirstName='$fname'";
					//echo $query;
				...
				if($query_run)
					{
						...
						else
						{
							...
							$query = "INSERT INTO dataenry(NIC, FirstName,LastName,TelephoneNo,Address,UserName,Password) VALUES('$nic','$fname','$lname','$address',$phone,'$username','$password')";
							$query_run = mysqli_query($con,$query);
							if($query_run)
							{
								...
								header( "Location:staffregDEO.php");
							}
							else
							{
