...
<html>
    ...
    <div id="box">
        <center><h2> Register Staff </h2>
            <form action="staffregcashierin.php" method="post">
                <table cellspacing="5">
                     <tr>
       ...
       <!--  <?php
			if(isset($_POST['register']))
			{
				...
				{
				$query = "SELECT * from cashier WHERE customer_name='$cname'";
					//echo $query;
				...
				if($query_run)
					{
						...
						else
						{
							...
							$query = "INSERT INTO cashier(NIC, FirstName,LastName,TelephoneNo,Address,UserName,Password) VALUES('$nic','$fname','$lname','$address',$phone,'$username','$password')";
							$query_run = mysqli_query($con,$query);
							if($query_run)
							{
