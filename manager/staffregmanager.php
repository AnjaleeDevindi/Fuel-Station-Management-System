...
<html>
    ...
    <div id="box">
        <center><h2> Register Staff </h2>
            <form action="staffregmanagerin.php" method="post">
                <table cellspacing="5">
                     <tr>
                ...
                <td><input type="password" placeholder="Enter Password" name="cpassword" id="confirm_password" required></td>
                    ...
                    <td><a href="staffregmanager.php"><button type="button" class="btn">New Record</button></a></td>
       ...
       <!--  <?php
			if(isset($_POST['register']))
			{
				...
				{
				$query = "SELECT * from manager WHERE customer_name='$cname'";
					//echo $query;
				...
				if($query_run)
					{
						...
						else
						{
							...
							$query = "INSERT INTO manager(NIC, FirstName,LastName,TelephoneNo,Address,UserName,Password) VALUES('$nic','$fname','$lname','$address',$phone,'$username','$password')";
							$query_run = mysqli_query($con,$query);
							if($query_run)
							{
