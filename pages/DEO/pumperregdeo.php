            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
                        <div class=panelbody>
  <form width=70% action="pumperreg-insert.php" method=post>
    ...
    <input type="text" id="cno" name="cno" placeholder="Enter Contact Number.."><br>

      <label for="uprice">Basic Salary</label><br>
    <input type="text" id="basicsalary" name="basicsalary" placeholder="Enter basic salary.."><br>
